  ...
  return (
    <div className="h-screen w-full">
      <div className="h-1/5 w-full flex items-center justify-end">
        <button className="mr-24 py-3  px-10 rounded-3xl bg-green-300">
          add new
        </button>
      </div>
  ...
  return (
    <div className="w-2/3 bg-white grid grid-cols-12 mb-2 rounded-tl-2xl rounded-br-2xl h-14 overflow-hidden">
      <div className="col-span-1 ">
        <div className="bg-green-300 w-1/2 text-center h-full flex flex-col justify-center rounded-br-2xl">
          {id + 1}
        </div>
      </div>
      <div className="col-span-8  flex items-center">{text}</div>
      <div className="col-span-2  flex items-center justify-center">
        <div className="bg-gray-900 w-9 h-9 rounded-circular"></div>
      </div>
